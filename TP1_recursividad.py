# 8) DESARROLLAR UN ALGORITMO QUE PERMITA CONVERTIR UN NUMERO ENTERO EN SISTEMA
...
#22) El problema de la mochila Jedi. Suponga que un Jedi:(luke, obi-wan kenobi,
# rey u otro, el que mas le guste) esta atrapado, pero muy cerca esta su mochila
# que contiene muchos objetos.
# implementar una funcion recursiva llamada "usar la fuerza" que le permita al jedi
